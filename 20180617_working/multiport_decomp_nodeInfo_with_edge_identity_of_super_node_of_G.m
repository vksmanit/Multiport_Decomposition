function [edges,g1_of_supernode] =  multiport_decomp_nodeInfo_with_edge_identity_of_super_node_of_G(cktnetlist)
% --------------------------------------------------------------------------------
% Syntax : [edges,g1_of_supernode] =  multiport_decomp_nodeInfo_with_edge_identity_of_super_node_of_G(cktnetlist)

% -------------------------------- Written on : May 29, 2018 ---------------------

    global g1_of_supernode;
    global edges;
    super_node  =  multiport_decomp_super_node_of_forest_of_G(cktnetlist);
    N = length(super_node);
