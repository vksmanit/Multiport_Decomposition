...
% --------------------------------------------------------------------------------
    ...
    [G_n2, J_n2] = multiport_decomp_incidence_matrix_for_network_02(cktnetlist);
    ...
    [G_n3, J_n3] = multiport_decomp_incidence_matrix_for_network_03(cktnetlist);
...
%{
    ...
    vn1_n2 = solution_of_system_using_lu(Ln2,U_n2,rhs_n2);
    ...
    vn1_n3 = solution_of_system_using_lu(Ln3,U_n3,rhs_n3);
    vg_n3 = A1g_n3' * vn1_n3 + A2g_n3' * vn_n3;
    ig_n3 = J_n3 + G_n3 * vg_n3;

           % index_for_n3 = index_for_n3 + 1;
       % end
   % end
%}
