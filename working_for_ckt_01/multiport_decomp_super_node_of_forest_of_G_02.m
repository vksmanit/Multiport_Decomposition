function super_node =  multiport_decomp_super_node_of_forest_of_G_02(cktnetlist)
% --------------------------------------------------------------------------------
% Syntax : super_node =  multiport_decomp_super_node_of_forest_of_G_02(cktnetlist)
...
% ---------------------------- Written on : May 29, 2017 -------------------------
    ...
    global nodeVisited;
    counter = 0;
    [edges, g1_of_forest,g1] = multiport_decomp_nodeInfo_forest_of_G_02(cktnetlist);
